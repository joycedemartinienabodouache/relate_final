...
import 'package:relate/configs/agora_configs.dart';
...
class CallScreen extends StatefulWidget {
  ...
  // CallScreen({Key key, @required this.call, this.role});
...
class _CallScreenState extends State<CallScreen> {
  ...
  void initState() {
    ...
    isRecordingGranted = widget.call.isRecordingGranted;
    print(widget.call.isRecordingGranted);
    if(isRecordingGranted == false){
      callMethods.secureScreen();
    }
